...
{ 
   ...
   void rightB(int speedB)
   {
    ...
    {
      speedA=map(y,1023,512,255,0);
      speedB=map(x,512,0,255,0);
   ...
   void oct2(int x,int y)
    {
      ...
      speedA=map(x,512,0,0,255);
      speedB=map(y,1023,512,0,255);
 ...
 void oct5(int x,int y)
    {
      speedA=map(y,512,0,0,255);
      speedB=map(x,1023,512,0,255);
 ...
 void oct6(int x,int y)                  //switching apparent oct3
    {
      speedA=map(x,1023,512,255,0);
      speedB=map(y,512,0,255,0);
